  ...
  if (error || !product) {
    return (
      <div className="text-center p-6">
        ...
        <Link href="/skincare" className="text-pink-500 hover:underline mt-4 block">
          Back to Skincare
        </Link>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="mb-8">
        <ol className="flex items-center space-x-2 text-sm">
          ...
          <li>
            <Link href="/skincare" className="text-gray-500 hover:text-pink-600">
              Skincare
            </Link>
          </li>
          <li>
      ...
      <div className="mt-16 border-t pt-8">
        <div className="max-w-4xl mx-auto">
          ...
          <button
            ...
            className="bg-pink-500 text-white px-6 py-2 rounded-lg hover:bg-pink-600 mb-8"
          >
            Write a Review
          </button>
        ...
        <div className="mt-16 border-t pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {recommendedProducts.map((recommendedProduct) => (
              ...
              >
                <Link href={`/skincare/${recommendedProduct.id}`}>
                  <img
                    src={getSafeImageSrc(recommendedProduct.image_link)}
                    alt={recommendedProduct.name}
                    className="w-full h-48 object-cover"
                  />
                </Link>
                <div className="p-4">
                  <h3 className="font-semibold mb-2">{recommendedProduct.name}</h3>
                  <p className="text-gray-600 text-sm mb-2">{recommendedProduct.brand}</p>
                  <p className="text-lg font-bold">₹{Math.round(recommendedProduct.price * 80)}</p>
                </div>
              </div>
            ))}
          </div>
